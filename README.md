...
2번 실수 후 번복하지 않기 위해 제작한 업무 자동화 도구입니다. <br>
...
| 구분      | 내용                                                                                                                                                 |
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| 기존요청 | 시스템 화면 전체 복사(불필요한UI텍스트 포함) `CTRL + A` > `CTRL + C`                                                                                 |
| 반환결과 | 홍길동 주무관님 <br><br>[김철수 의원(OO위, OO위)]<br><br>1. OOO 관련 자료요구<br> OOO 관련하여 OOO한 자료 부탁드립니다.<br><br>답변기한 : 2026-04-08 |
